...
class AdminSystemSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.system_setting.index', compact('systemData'));
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($systemData && is_array($systemData)) {
            ...
            return redirect()->route('backend.system.setting')->with('message', trans('validation.notice.update_system_success'));
        }
