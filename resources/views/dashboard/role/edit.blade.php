...
@section('content')
  ...
  <form method="post" action="{{ route('dashboard.dashboard.role.update', $role->id) }}" accept-charset="utf-8">
    {{ method_field('put') }}
    {{ csrf_field() }}
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="tab_1">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="description" cols="45" rows="2" maxlength="200" placeholder="角色(用户组)描述"
                      autocomplete="off">{{ $role->description }}</textarea>
          </div>
          <div class="form-group">
            <label>关联权限</label>
