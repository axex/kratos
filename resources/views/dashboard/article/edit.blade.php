...
@section('content')
  ...
  <form method="post" action=" {{ route('dashboard.dashboard.article.update', $article->id) }}" accept-charset="utf-8">
    {{ method_field('put') }}
    {{ csrf_field() }}
    <div class="nav-tabs-custom">
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="tab_1">
          ...
          <div class="form-group">
            <label>推荐者</label>
            <input type="text" class="form-control" name="presenter" value="{{ $article->presenter }}"
                   placeholder="推荐者">
          </div>
          <div class="form-group">
            <div class="row">
              <div class="col-md-2">
                ...
                <div class="input-group">
                  <select data-placeholder="选择期数..." class="chosen-select" style="min-width:200px;" name="issue">
                    <option value="{{ $article->issue }}">第 {{ $article->issue }} 期</option>
          ...
          <div class="form-group">
            ...
            <textarea id="container" name="desc">{{ $article->desc }}</textarea>
