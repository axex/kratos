...
@section('content')
    ...
    <a href="{{ route('backend.role.create') }}" class="btn btn-primary margin-bottom">新增角色</a>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body table-responsive">
            <table class="table table-hover table-bordered">
                ...
                @foreach ($roles as $role)
                    <tr>
                        <td>
                            <a href="{{ route('backend.role.index') }}/{{ $role->id }}/edit"><i class="fa fa-fw fa-pencil" title="修改"></i></a>
        ...
        <!--隐藏型删除表单-->
        <form method="post" action="{{ route('backend.role.destroy') }}" accept-charset="utf-8" id="hidden-delete-form">
            {{ method_field('delete') }}
            {{ csrf_field() }}
        </form>
    ...
    var action = '{{ route('backend.role.index') }}';
    var id = $(this).data('id');
