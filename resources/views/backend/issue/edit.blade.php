...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('backend.article.index') }}">内容管理 - 期数</a></li>
        <li class="active">修改期数</li>
    </ol>
@stop
...
@section('content')
    ...
    <form method="post" action=" {{ route('backend.issue.update', $issue->id) }}" accept-charset="utf-8">
        {{ method_field('put') }}
        {{ csrf_field() }}
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab_1">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="issue" value="{{ $issue->issue }}"
                               placeholder="期数">
                    </div>
                    <div class="form-group">
                        <label>发布日期</label>
                        <input type="text" id="date" class="form-control" name="published_at" readonly placeholder="{{ $issue->published_at }}">
                    </div>
                </div><!-- /.tab-pane -->
                <button type="submit" class="btn btn-primary">修改期数</button>
