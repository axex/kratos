...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('backend.category.index') }}">内容管理 - 分类</a></li>
...
@section('content')
    ...
    <form method="post" action="{{ route('backend.category.store') }}" accept-charset="utf-8">
        {{ csrf_field() }}
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab_1">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="分类名称" maxlength="20">
                    </div>
                    <div class="form-group">
                        <label>分类缩略名 <span class="text-green small">只能是字母或数字</span></label>
                        <input type="text" class="form-control" name="slug" value="{{ old('slug') }}" placeholder="分类缩略名" maxlength="20">
                    </div>
                    <div class="form-group">
                        <label>分类描述 <span class="text-green small">建议百字以内，有助于网站SEO</span></label>
                        <textarea class="form-control" name="desc" cols="45" rows="2" maxlength="200" placeholder="分类描述">{{ old('desc') }}</textarea>
                    </div>
                </div><!-- /.tab-pane -->
