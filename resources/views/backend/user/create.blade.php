...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('backend.user.index') }}">用户管理 - 管理员</a></li>
...
@section('content')
    ...
    <form method="post" action="{{ route('backend.user.store') }}" accept-charset="utf-8">
        {{ csrf_field() }}
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab_1">
                    <div class="form-group">
                        <label>登录（用户）名 <small class="text-red">*</small> <span class="text-green small">只能至少3位字母和数字，以及破折号和下划线的组合</span></label>
                    ...
                    <div class="form-group">
                        <label>初始化登录密码 <small class="text-red">*</small> <span class="text-green small">只能6-16位</span></label>
