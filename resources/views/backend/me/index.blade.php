...
@section('content')
    ...
    <div class="box box-primary">
        ...
        <div class="col-md-6">
            <form id="setting-form" method="post" action="{{ route('backend.me') }}" accept-charset="utf-8">
                {{ csrf_field() }}
                <div class="box-body">
        ...
        <div class="col-md-5">
            <form method="post" action="{{ route('backend.avatar') }}" enctype="multipart/form-data" id="upload-form">
                <div class="box-body">
